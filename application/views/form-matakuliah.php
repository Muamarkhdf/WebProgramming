...
<form action="<?= base_url('matakuliah/cetak') ?>" method="POST">
    <div class="form-group">
        ...
        <?= form_error('kode', '<div class="text-info">', '</div>') ?>
    </div>
    <div class="form-group">
        ...
        <?= form_error('nama', '<div class="text-info">', '</div>') ?>
    </div>
    ...
    <div class="form-group">
        ...
        <select name="sks" id="sks" class="form-control">
            ...
            <option value="5" <?= set_select('sks', '5') ?>>5</option>
            <option value="6" <?= set_select('sks', '6') ?>>6</option>
        </select>
        <?= form_error('sks', '<div class="text-info">', '</div>') ?>
    </div>
